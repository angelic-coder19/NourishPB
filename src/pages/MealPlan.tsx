...
const breakfastOptions: PlanMeal[] = [
  ...
  },
  {
    ...
    description: "Healthy fats and lycopene to start the day.",
    image: mealChickpea,
    searchTerm: "avocado",
    ingredients: [
      { name: "Whole grain bread", price: 2.5 },
  ...
  },
  {
    ...
    description: "Plant omega-3s and antioxidants.",
    image: mealOatmeal,
    searchTerm: "chia seeds",
    ingredients: [
  ...
  {
    name: "Veggie Scramble with Spinach",
    description: "Protein and leafy greens to fuel your morning.",
    image: mealChickpea,
    searchTerm: "eggs",
    ingredients: [
      { name: "Eggs", price: 1.5 },
...
const lunchOptions: PlanMeal[] = [
  ...
  },
  {
    ...
    description: "Fiber-rich legumes with greens and tomato.",
    image: mealChickpea,
    searchTerm: "chickpeas",
    ingredients: [
      { name: "Chickpeas (1 can)", price: 1.19 },
      { name: "Kale", price: 1.49 },
      { name: "Cherry tomatoes", price: 0.9 },
      { name: "Olive oil", price: 0.5 },
    ],
    total: 4.08,
    calories: 480,
    instructions: [
      ...
      "Top with chickpeas and tomatoes.",
    ],
  },
  {
    name: "Sweet Potato & Black Bean Tacos",
    description: "Fiber-rich roots with plant protein.",
    image: mealLentil,
    searchTerm: "sweet potato",
    ingredients: [
      { name: "Sweet potatoes", price: 1.5 },
      { name: "Black beans (1 can)", price: 1.28 },
      { name: "Whole grain tortillas", price: 2.0 },
    ...
    instructions: [
      ...
      "Fill tortillas; top with cilantro and lime.",
    ],
  },
  {
    name: "Tuna & White Bean Salad",
    description: "Lean omega-3 protein with fiber.",
    image: mealChickpea,
    searchTerm: "tuna",
    ingredients: [
      { name: "Canned tuna in water", price: 1.5 },
      { name: "Cannellini beans", price: 1.25 },
      { name: "Mixed greens", price: 2.0 },
      { name: "Olive oil", price: 0.5 },
    ],
    total: 5.25,
  ...
  },
  {
    ...
    description: "Complete protein with antioxidant veggies.",
    image: mealChickpea,
    searchTerm: "quinoa",
    ingredients: [
    ...
    instructions: [
      ...
      "Combine and dress with olive oil and lemon.",
    ],
  },
];
...
const dinnerOptions: PlanMeal[] = [
  ...
  {
    name: "Catfish with Roasted Sweet Potatoes",
    description: "Locally sourced lean fish with fiber-rich roots.",
    image: mealSalmon,
    searchTerm: "catfish",
    ingredients: [
      { name: "Catfish fillet", price: 5.0 },
      { name: "Sweet potatoes", price: 1.5 },
      { name: "Broccoli", price: 1.5 },
      { name: "Olive oil", price: 0.5 },
    ],
    ...
    instructions: [
      ...
      "Roast sweet potatoes and broccoli alongside.",
    ],
  },
  {
    name: "Tilapia Veracruz",
    description: "Lean fish with tomatoes and herbs.",
    image: mealSalmon,
    searchTerm: "tilapia",
    ingredients: [
      { name: "Tilapia fillet", price: 4.5 },
      { name: "Tomatoes", price: 0.9 },
      { name: "Onion", price: 0.75 },
      { name: "Garlic", price: 0.3 },
      { name: "Brown rice", price: 1.5 },
  ...
  },
  {
    ...
    description: "Plant protein with antioxidant veggies.",
    image: mealLentil,
    searchTerm: "tofu",
    ingredients: [
      { name: "Firm tofu", price: 2.5 },
      { name: "Broccoli", price: 1.5 },
    ...
    instructions: [
      ...
      "Toss with low-sodium soy sauce; serve over rice.",
    ],
  },
  {
    name: "Turkey Chili",
    description: "Lean protein and fiber-rich beans.",
    image: mealLentil,
    searchTerm: "ground turkey",
    ingredients: [
      { name: "Ground turkey", price: 5.0 },
      { name: "Kidney beans", price: 1.25 },
  ...
  },
  {
    ...
    description: "Lean turkey, brown rice and antioxidants.",
    image: mealChickpea,
    searchTerm: "bell peppers",
    ingredients: [
      { name: "Bell peppers", price: 2.0 },
      { name: "Ground turkey", price: 5.0 },
      { name: "Brown rice", price: 1.5 },
      { name: "Tomatoes", price: 0.9 },
    ],
    ...
    instructions: [
      ...
      "Stuff peppers; bake at 375°F for 25 minutes.",
    ],
  },
];
